...
publications <- GET(
  ...
  query = list(
     db = "pubmed", id = paste(ids, collapse = ","), retmax = 1000, rettype = "abstract"
    )
)
...
institution <- str_extract_all(
  publications_txt,
  "University\\s+of\\s+[[:alpha:]\\s]+|[[:alpha:]\\s]+Institute\\s+of\\s+[[:alpha:]\\s]+"
  ) 
